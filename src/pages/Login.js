        ...
        <div className="login" style={{ marginTop: '10%', width: '300px' }}>
            <div className="loginFieldGroup">
                <Grid container spacing={2} style={{ width: '100%', boxShadow: '-5px 5px 6px 6px #695f55', borderRadius: '10px' }}>
                    ...
                    <Grid item xs={12} spacing={6} align="center">
                        <CustomButton text='Log in' color="primary" theme={theme} url="/login" onClick={() => { consoleLogInfo() }} />
                        <text style={{ fontSize: '12px', color: '#695f55'}}>If you don't have an account, go to <strong><a href='/register' style={{ color: 'red' }}>register</a></strong> page !</text>
                    </Grid>
                </Grid>
            </div>
